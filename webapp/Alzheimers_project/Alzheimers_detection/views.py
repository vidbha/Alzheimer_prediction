...
def predict(request):
    svm_model = loadFile("C:\\Users\\vidhi\\Downloads\\alzheimer_pred\\svm_model.pkl")
    svm_numerical = loadFile("C:\\Users\\vidhi\\Downloads\\alzheimer_pred\\svm_numerical.pkl")
